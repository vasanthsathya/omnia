...
1. Generate the inventory file based on the mapping file. For the sample map and inventory files, see :doc:`Set PXE Boot Order <../omnia/docs/source/OmniaInstallGuide/samplefiles.rst>`.
