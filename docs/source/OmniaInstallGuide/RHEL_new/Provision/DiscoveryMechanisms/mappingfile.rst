...
::
    ...
    slurm_node_x86_64,x1000c1s7b1n0,n1,xx:yy:zz:aa:bb:cc,10.5.0.101,10.3.0.101
    login_node_default_x86_64,x1000c1s7b1n1,n2,aa:bb:cc:dd:ee:ff,10.5.0.102,10.3.0.102
...
.. note::
    ...
    * The ADMIN_MAC and BMC_MAC address provided in ``pxe_mapping_file.csv`` should refer to the PXE NIC and BMC NIC on the target nodes respectively.
